    ...
    amqp.connect('amqps://nztaiger:Lun5OT9tHUlr2ZizcqsiTN_0bJ06qLgR@cow.rmq2.cloudamqp.com/nztaiger', function (error0, connection) {
        ...
        connection.createChannel(function (error1, channel) {
            ...
            channel.consume('product_created', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
                var eventProduct, product, result, dbError_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            result = _a.sent();
                            consola.success({ message: "product created, ".concat(product.id), badge: true });
                            return [3 /*break*/, 3];
                        case 2:
                            dbError_1 = _a.sent();
                            consola.error({ message: "product not created, ".concat(dbError_1.message), badge: true });
                            return [3 /*break*/, 3];
